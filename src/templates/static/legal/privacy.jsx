...
const Privacy = () => (
    <div>
        ...
        <p>{it.L('The Company operates in full compliance with the General Data Protection Regulation (GDPR) and other applicable Data Protection laws. These regulatory measures oblige the Company to use the client\'s personal data according to the principles of fair, lawful, and transparent information processing.')}</p>
